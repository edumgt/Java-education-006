 ...
 * 컨트롤러 (Controller) 로 제어함으로서 모델과 뷰의 재사용성을 높이는 설계 방식을 의미한다. (+ 즉, MVC 패턴은
 * 모델과 뷰의 결합도를 낮추는게 핵심이라는 것을 알 수 있다.)
 *
 * 뷰 (View) 란?
 ...
 *
 * 모델 (Model) 이란?
 * - 사용자에게 보여 줄 데이터를 처리하는 구성 요소를 의미한다. (+ 즉, 모델은 뷰를 통해 사용자에게 노출 된다는 것을
 * 알 수 있다.)
 *
 * 컨트롤러 (Controller) 이란?
